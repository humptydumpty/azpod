        ...
        for (i = 0; i < res_length; i++) {
            for (j = 0; j < res_length; j++) {
                for (z = 0; z < res_length; z++) {
                    for (zz = 0; zz < res_length; zz++) {
                        for (l = 0; l < res_length; l++) {
                            for (k = res_length - 1; k < res_length; k++) {
                                int tempp = result[i] + result[j] + result[z] + result[l] + result[k] + result[zz];
        ...
        for (t = max + 1; t <= min_left[0].val; t++) {
                ...
                for (k = j; k < res_length; k++) {
                    for (l = k; l < res_length; l++) {
                        for (z = l; z < res_length; z++) {
                            for (zz = z; zz < res_length; zz++) {
                                search(t + result[j] + result[k] + result[l] + result[z] + result[zz]);
                            }
                        }
                    }
                }
            ...
            for (j = 0; j < res_length; j++) {
                for (k = j; k < res_length; k++) {
                    for (l = k; l < res_length; l++) {
                        for (z = l; z < res_length; z++) {
                            search((2 * t) + result[j] + result[k] + result[l] + result[z]);
                        }
                    }
                }
            }
            for (k = 0; k < res_length; k++) {
                for (l = k; l < res_length; l++) {
                    for (z = l; z < res_length; z++) {
                        search((3 * t) + result[k] + result[l] + result[z]);
                    }
                }
            }
